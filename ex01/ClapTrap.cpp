...
/*   Updated: 2024/09/12 10:17:19 by thlefebv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap():m_name("Clapp"), m_hitPoint(10), m_energyPoint(10), m_attackDamage()
{
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	if(this->m_hitPoint > 10)
	{
		...
		std::cout << "He is at : " << this->m_hitPoint << " hp" << std::endl;
	}
	else
